        ...
        <div class="panel-body border-bottom">      
            <div class="row">
                <div class="col-lg-4 label-img-size">
                    <a href="#" class="post-label">
                    	              <!-- ↓ 验证图片文件是否存在，不存在就展示默认图片 -->
                        <img src="<?=(file_exists(Yii::getAlias('@webroot').$list['label_img']) ? \Yii::$app->params['upload_url'].$list['label_img'] : \Yii::$app->params['default_label_img'])?>" alt="<?=$list['title']?>">
                    </a>
                </div>
            ...
            <div class="tags">
                ...
                <span class="fa fa-tags"></span>
                    ...
                    <a href="<?=Url::to(['post/index','tag'=>$lt])?>"><?=$lt?></a>，
                    <?php endforeach;?>
                <?php endif;?>
            </div>
        </div>
